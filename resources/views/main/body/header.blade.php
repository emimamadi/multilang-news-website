...
$horizental=DB::table('ads')->where('type',2)->first();
...
<ul>
    ...
    @else
    <li class="version"><a href="{{route('lang.hindi')}}"><B>فارسی</B></a></li>&nbsp;&nbsp;&nbsp;
    @endif
    ...
    <li>
        <div class="dropdown">
            ...
            <a href="{{ $social->facebook }}" target="blank"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a>
            <a href="{{ $social->twitter }}" target="blank"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a>
            <a href="{{ $social->youtube }}" target="blank"><i class="fa fa-youtube-play" aria-hidden="true"></i> Youtube</a>
            <a href="{{ $social->instagram }}" target="blank"><i class="fa fa-instagram" aria-hidden="true"></i> Instagram</a>
            </div>
        </div>
    </li>
</ul>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    @else
                   <a href="{{$horizental->link}}" target="_blank"><img src="{{asset($horizental->ads)}}" alt="" /></a> 
                    @endif
                   </div>
				</div>
			</div>
