	 ...
	 <div class="service-img"><a href="#"><img src="{{asset($firstsectionbig->image)}}" width="800px" alt="Notebook"></a></div>
		 ...
		 <h4 class="lead-heading-01"><a href="{{ URL::to('view/post/'.$firstsectionbig->id) }}">
					...
					<div class="row">
						...
						@php
						$horizental=DB::table('ads')->where('type',2)->skip(1)->first();
						@endphp
							<div class="add">
							@if ($horizental==NULL)
								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="top-news">
											...
											<img src="{{asset($secondcatpostbig->image)}}" alt="Notebook"></a>
...
$fourcatpostsmall = DB::table('posts')->where('category_id',$fourcategory->id)->where('bigthumbnail',NULL)->limit(3)->get();
			...
			<div class="row">
			@php
			$horizental=DB::table('ads')->where('type',2)->skip(2)->first();
			@endphp
				<div class="col-md-6 col-sm-6">
					<div class="add">
					@if ($horizental==NULL)
				...
				<div class="col-md-6 col-sm-6">
				@php
				$horizental=DB::table('ads')->where('type',2)->skip(3)->first();
				@endphp
					<div class="add">
					@if ($horizental==NULL)
