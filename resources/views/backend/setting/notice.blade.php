...
@if($notice->status==1)
  ...
  <a href="{{route('deactive.notice',$notice->id)}}">  <button type="button" class="btn btn-primary btn-fw">Deactive</button></a>
...
<small class="text-danger">Now Notice Are Active</small>
