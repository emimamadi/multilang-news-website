                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img src="{{ (!empty($editData->image))?url('upload/user_images/'.$editData->image):url('upload/no_image.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">User Name : {{ Auth::user()->name}}</p>
