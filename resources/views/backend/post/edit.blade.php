...
<form class="forms-sample" action="{{ route('update.post',$post->id) }}" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
          ...
          <div class="form-group col-md-6">
          <label for="exampleInputName1">Title Fa</label>
      ...
      <div class="form-group col-md-6">
          ...
          <select class="form-control" id="exampleSelectGender"  name="district_id">
              ...
              <option value="{{$row->id}}" <?php if($row->id==$post->district_id){ echo "selected"; } ?>
      ...
      <select class="form-control" id="subdistrict_id" name="subdistrict_id">
        <option disabled="" selected="">--Select SubDistrict--</option>
              ...
              <option value="{{$row->id}}" <?php if($row->id==$post->subdistrict_id){ echo "selected"; } ?>
    ...
    <div class="row">
      ...
      <div class="form-group col-md-6">
      <label for="exampleInputName1">Tags Fa</label>
      <input type="text" class="form-control" id="exampleInputName1" name="tags_hin" value="{{ $post->tags_en }}">
      </div>
    ...
    <div class="form-group">
        <label for="exampleTextarea1">Details Fa</label>
